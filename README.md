...
```bash
python s1_pipeline/s2_inpainting.py \
...
- `--input_video_path`: Path to the splatting video result generated by the first step (e.g., `./out/vid_1_splatting.mp4`).
- `--output_path`: Directory for the output stereo video (e.g., `./out`).
...
```bash
python s1_pipeline/s3_greenscreen.py \
  --input_video_path ./out/vid_2_sbs.mp4 \
...
```bash
python s1_pipeline/s4_interpolation.py \
  --input_video_path ./out/vid_3_greenscreen.mp4 \
...
```bash
python s1_pipeline/s5_upscale.py \
  --input_video_path ./out/vid_4_interp.mp4 \
...
```bash
python s1_pipeline/s6_green_cleanup.py \
  --input_video_path ./out/vid_5_upscale.mp4 \
