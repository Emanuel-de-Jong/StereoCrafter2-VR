...
class DepthCrafterPipeline(StableVideoDiffusionPipeline):
    ...
    def __call__(
        ...
        print("==> encoding video embeddings", flush=True)
        ...
        print("==> encoding video latents", flush=True)
        ...
        if track_time:
            ...
            print(f"Elapsed time for encoding video: {elapsed_time_ms} ms", flush=True)
        ...
        if not output_type == "latent":
            ...
            if track_time:
                ...
                print(f"Elapsed time for decoding video: {elapsed_time_ms} ms", flush=True)
